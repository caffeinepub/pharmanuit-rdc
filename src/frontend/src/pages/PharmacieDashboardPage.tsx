...
import { getCallsThisMonth, getCallsToday } from "../utils/callTracking";
  ...
  return (
    ...
    >
      <div className="px-4 py-4 space-y-4 max-w-lg mx-auto">
        ...
        {pharmacy && (
          <div
            className="bg-success/10 border border-success/20 rounded-lg px-4 py-4 flex items-center gap-4"
            data-ocid="dashboard.calls_today.card"
          >
        ...
        {pharmacy && (
          <div
            className="bg-secondary border border-border rounded-lg px-4 py-4 flex items-center gap-4"
            data-ocid="dashboard.calls_month.card"
          >
